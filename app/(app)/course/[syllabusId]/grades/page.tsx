...
function GradeCell({
  ...
  return (
    <input
      ...
      className={[
        "w-full rounded-lg border border-[#1F1F1F] bg-[#0A0A0A] px-2 py-1.5 text-center text-sm",
    ...
    >
      <div className="w-full max-w-sm rounded-2xl border border-[#1F1F1F] bg-[#111111] p-6 shadow-2xl">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-sm font-semibold text-[#F9FAFB]">Add Grade Entry</h2>
          <button onClick={onClose} title="Close" className="rounded-lg p-1.5 text-[#6B7280] hover:bg-[#1F1F1F] hover:text-[#F9FAFB] transition">
        ...
        <div className="space-y-3">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-[#1F1F1F] bg-[#0A0A0A] px-3 py-2 text-sm placeholder:text-[#4B5563] focus:outline-none focus:border-[#4ADE80]/50"
            />
          </div>
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <select
                ...
                className="w-full rounded-lg border border-[#1F1F1F] bg-[#0A0A0A] px-3 py-2 text-sm focus:outline-none focus:border-[#4ADE80]/50"
              >
    ...
    <main className="min-h-screen bg-[#0A0A0A]">
      ...
      <div className="border-b border-[#1F1F1F] bg-[#0A0A0A] px-4 pt-8 pb-0">
        <div className="mx-auto max-w-4xl">
          ...
          <h1 className="text-xl font-bold text-[#F9FAFB]">Grades</h1>
      ...
      <div className="mx-auto max-w-4xl px-4 py-8 space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          ...
          <div className="rounded-2xl border border-[#1F1F1F] bg-[#111111] p-5">
            ...
            <select
              ...
              className="w-full rounded-lg border border-[#1F1F1F] bg-[#0A0A0A] px-2 py-1.5 text-sm focus:outline-none focus:border-[#7DD3FC]/50"
            >
        ...
        {assignments.length === 0 ? (
          <div className="rounded-2xl border border-[#1F1F1F] bg-[#111111] py-16 flex flex-col items-center gap-3 text-center">
            ...
            <p className="text-sm text-[#F9FAFB] font-medium">No assignments yet</p>
          ...
          <div className="rounded-2xl border border-[#1F1F1F] bg-[#111111] overflow-hidden">
            {/* table header */}
            <div className="grid grid-cols-[1fr_80px_90px_90px_90px_32px] gap-x-2 px-4 py-2.5 border-b border-[#1F1F1F] bg-[#0A0A0A]">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          <p className="text-sm text-[#F9FAFB] truncate">{a.title}</p>
                          {a.isCustom && (
            ...
            {/* ── progress bar footer ─────────────────────────────────────── */}
            {hasAnyInput && (
              <div className="px-4 py-3 bg-[#0A0A0A] flex items-center gap-3">
